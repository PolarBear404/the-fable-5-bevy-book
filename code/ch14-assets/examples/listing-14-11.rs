//! Listing 14-11：缝进戏服的场记板——embedded_asset 把文件嵌进可执行文件
...
fn raise_clapper(mut commands: Commands, asset_server: Res<AssetServer>) {
    ...
    // 嵌入资产住在 embedded:// 来源下；“crate 名”是本例的可执行名 listing_14_11
    let clapper: Handle<Image> =
        asset_server.load("embedded://listing_14_11/embedded/clapper.png");
