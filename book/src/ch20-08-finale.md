...
对照读一遍官方 `vendor/bevy/examples/showcase/breakout.rs` 也是好功课：你会认出同款的常量表、同款的判面函数、同款的“迎面才反弹”，也会看出分岔——它没有状态机、没有命数、球永远撞底墙弹回，而你的版本有开有合、有胜有负。**能看懂官方示例的每一行，还能说出自己为什么不这么写**——这就是这一部分要带你到的地方。
