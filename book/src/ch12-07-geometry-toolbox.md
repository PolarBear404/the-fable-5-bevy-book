...
![示意图：橙色虚线矩形是取景框，地球的点在框内、彗星的点在框外上方；灰色环带是小行星带，外逃到 (450,0) 的石头被箭头押回外圈的 (380,0)，内坠到 (120,160) 的石头被箭头提到内圈的 (180,240)](images/ch12/fig-12-11-annulus-clamp.svg)

<span class="caption">Figure 12-11：观测站的几何题摆在同一张图上——Rect 答“在不在镜头里”，Annulus 的 closest_point 把越界的石头各自归位</span>
