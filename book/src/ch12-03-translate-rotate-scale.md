...
![两幅并排截图：左幅地球公转到 45° 处，方块斜成菱形；右幅公转到 115° 处，方块的倾角也跟到 115°；两幅里朝向太阳的那条棱都正对着太阳，居中的太阳方块始终端正](images/ch12/fig-12-05-tidal-lock.png)

<span class="caption">Figure 12-5：rotate_around 的副产品，两个时刻对照——公转转过多少度，自转同步多少度，同一条棱始终对着太阳</span>
