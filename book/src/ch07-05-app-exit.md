...
下一章是消息的镜像。Message 是**拉**模式：写者投递，读者下次轮到自己时才来取，中间隔着调度——这让批量处理高效，也意味着响应永远慢半拍，且无法瞄准“某一个实体”。当你需要“事情一发生就立刻处理”“精确通知挂在这个实体上的逻辑”时，就轮到 **Event 与 Observer**——`Event` 这个名字专属于它们。
