...
回到 Figure 22-5 那盏灯笼：灯泼到的地方亮，泼不到的角落不是纯黑，还能看出个轮廓。这层「兜底的光」第 21 章见过——`StandardMaterial` 是受光材质，没有直接光照到的面，靠的就是它。现在把它讲全。
...
![左右对照：左幅灯笼照不到的地方近乎死黑、暗部毫无细节；右幅同一场景，暗部被一层冷蓝的环境光托起，立柱背光面、地面边缘都透出隐约的蓝调，夜色更通透](images/ch22/fig-22-07-ambient.png)

<span class="caption">Figure 22-7：左边只有默认环境光，暗部近乎死黑；右边补一层偏蓝月色，夜色立刻通透</span>
