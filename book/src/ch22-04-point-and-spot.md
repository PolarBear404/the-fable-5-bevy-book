...
![示意图：左边平行光，一束平行箭头斜射而下，标注「只有方向，亮度记 lux」；中间点光，箭头从一个点向四面八方放射，标注「有位置，亮度记 lumens，越远越暗」；右边聚光，箭头收在一个圆锥里，标注「有位置有朝向，内锥全亮、外锥渐隐」](images/ch22/fig-22-07-light-types.svg)

<span class="caption">Figure 22-7：三种灯的发光几何——平行光满台平行，点光四散放射，聚光收成一束</span>
...
![入夜的园子：天幕墨黑，一盏暖黄的灯笼从台子上方把光泼下来，正中心最亮，向四周与地面边缘渐渐沉入黑暗，立柱在地上投出放射状的影子](images/ch22/fig-22-08-point-light.png)

<span class="caption">Figure 22-8：一盏灯笼——光从一点泼开，中心亮、边缘暗，超出射程便沉入夜色</span>
...
![入夜的园子：一束圆锥光从高处斜罩台中央的绣球，照亮的是一个边缘清晰的椭圆光斑，斑内全亮、向边缘柔和地暗下去，斑外漆黑](images/ch22/fig-22-09-spot-light.png)

<span class="caption">Figure 22-9：一盏追光——光收在圆锥里，落地是一个内亮外柔的光斑</span>
