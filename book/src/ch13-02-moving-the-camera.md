...
![并排动图：左侧硬跟随的画面里红色侠客始终钉在正中央，右侧 smooth_nudge 的画面里侠客在中心附近游移，镜头带着延迟追赶](images/ch13/fig-13-02-follow-compare.webp)

<span class="caption">Figure 13-2：两版跟拍同台对比（动图）——左路阿燕焊死在画面中央，右路镜头慢半拍地追，世界的流动也因此柔和</span>
