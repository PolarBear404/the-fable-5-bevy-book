...
![示意图：左半幅把立方体贴图的六张面展开成盒子——上为天光、下为地板、四壁是带灯笼暖光的墙；右半幅一颗镜面金属球，相机的视线打到球面一点，沿法线反射出去的方向正对应到盒子的某一面，取那个方向的颜色](images/ch22/fig-22-11-cubemap-ibl.svg)

<span class="caption">Figure 22-11：环境光照的道理——把周遭装进一个立方体贴图盒子，金属表面每个可见点按反射方向到盒子里取色，于是「照出」了整座暖阁</span>
...
![左右对照：左幅一颗金属球漆黑如墨、只在顶上有一点微光，几乎看不出是金属；右幅同一颗球，整片球面映出暖阁的样子——顶上的天光、四壁的灯笼暖光、暗下去的地板，金属质感扑面而来](images/ch22/fig-22-12-metal-world.png)

<span class="caption">Figure 22-12：左边没有环境光照、金属球无物可映，黑得和第 21 章一样；右边环境光照接管，球面映出整座暖阁</span>
